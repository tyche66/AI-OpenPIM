...
class TestRealParsers:
    ...
    async def test_docx_extracts_real_text(self):
        ...
        result = await parser.parse(_make_docx_bytes("AI-OpenPIM DOCX fixture"), file_name="a.docx")
        assert "AI-OpenPIM DOCX fixture" in result.text
    ...
    async def test_pdf_extracts_real_text(self):
        ...
        result = await parser.parse(
            _make_text_pdf_bytes("AI-OpenPIM PDF fixture"), file_name="a.pdf"
        )
        assert "AI-OpenPIM PDF fixture" in result.text
