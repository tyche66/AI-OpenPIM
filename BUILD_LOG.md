# AI-PIM OpenPIM Release Candidate 构建日志
...
- 当前阶段：V1.9.x — 后台界面与交互打磨；AI 能力生产就绪的基线自 V1.8.0 起不变（Knowledge Gateway + AI Portal + 统一演示入口）。
  ...
  - AI_CHAT_MODEL=gpt-4o-mini（原 V1.2 默认为 gpt-4o-mini）
  - AI_API_URL 可通过环境变量覆盖（默认 https://api.openai.com/v1）
...
- 构建环境: /home/AI-PIM/OpenPIM
- 后端根目录: /home/AI-PIM/OpenPIM/backend
- 前端根目录: /home/AI-PIM/OpenPIM/frontend
- Portal 根目录: /home/AI-PIM/OpenPIM/portal
- 构建产物位置: /home/AI-PIM/OpenPIM/frontend/dist + /home/AI-PIM/OpenPIM/portal/dist
...
| AI 适配器默认启用 | 完成 | AI_ADAPTER=openai 为默认，AI_CHAT_MODEL=gpt-4o-mini |
...
- 前端生产产物: `/home/AI-PIM/OpenPIM/frontend/dist`
- 后端应用源码: `/home/AI-PIM/OpenPIM/backend/app`
- 后端镜像: `richangpim-backend:latest`
- Compose 配置: `/home/AI-PIM/OpenPIM/docker-compose.yml`
- Nginx 配置: `/home/AI-PIM/OpenPIM/docker/nginx/nginx.conf`
